...
NOTE: This use case assumes the concept of 'collaborators'. This implies a grouping of user that needs to be explorted in further details through additional use cases.
