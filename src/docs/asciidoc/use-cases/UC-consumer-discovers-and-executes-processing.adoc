...
. The Consumers billing account is updated comensurate with the 'cost' of the processing
...
. Optionally, the Consumer publishes their results in the catalogue - specifying all necessary metadata to support dicovery
