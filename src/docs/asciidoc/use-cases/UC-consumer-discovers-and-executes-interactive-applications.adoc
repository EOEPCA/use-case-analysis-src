...
. Consumer uses the application to perform analytics using the imput data
...
Rather that discovering a starting a new application instance, instead they list existing 'live' sessions, that they can rejoin
